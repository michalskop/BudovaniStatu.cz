 ...
 * \ingroup data
 *
 * Provides an interface to database table ORGANIZATION_IN_GROUP that holds memberships of MPs in groups.
 *
 * Columns of table MP_IN_GROUP are: <code>organization_id, group_id, role_code, since, until</code>.
 *
 * All columns are allowed to write to.
 *
 * Primary key consists of columns <code>mp_id, group_id, role_code, since</code>.
 */
class OrganizationInGroup
{
	...
	public function __construct()
	{
		$this->entity = new Entity(array(
			'name' => 'organization_in_group',
			'columns' => array('organization_id', 'group_id', 'role_code', 'since', 'until'),
			'pkey_columns' => array('organization_id', 'group_id', 'role_code', 'since')
		));
	}
